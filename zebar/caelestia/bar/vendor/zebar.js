...
// node_modules/glazewm/dist/index.mjs
var WmClient = class {
  /**
...
// node_modules/zebar/dist/index.js
...
function createProviderGroup(configMap) {
  ...
  return {
    ...
    get hasErrors() {
      return Object.keys(errorMap2).length > 0;
    },
    configMap,
    raw: providerMap,
    onOutput: (callback) => {
